...
function updateRoutesFile(model, file, gen) {
    ...
    model() {
      ...
      this.models.forEach((model) => {
        ...
        if (this.fs.exists(this.destinationPath(`model/${model.slugName}/${model.slugName}-controller.js`))) {
          ...
          file = updateRoutesFile(model, file, this);
        }
      });
      // Once done we rewrite the routes file
